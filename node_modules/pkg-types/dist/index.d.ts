...
interface PackageJson {
     ...
     * - The name canâ€™t start with a dot or an underscore.
     * - New packages must not have uppercase letters in the name.
     * - The name ends up being part of a URL, an argument on the command line, and a folder name. Therefore, the name canâ€™t contain any non-URL-safe characters.
     */
    name?: string;
    /**
    ...
    version?: string;
    /**
     * Put a description in it. Itâ€™s a string. This helps people discover your package, as itâ€™s listed in `npm search`.
     */
    description?: string;
    /**
    ...
    homepage?: string;
    /**
     * The url to your projectâ€™s issue tracker and / or the email address to which issues should be reported. These are helpful for people who encounter issues with your package.
     */
    bugs?: string | {
        url?: string;
        email?: string;
    ...
    private?: boolean;
    /**
     * The â€œauthorâ€ is one person.
     */
    author?: PackageJsonPerson;
    /**
     * â€œcontributorsâ€ is an array of people.
     */
    ...
    main?: string;
    /**
     * If your module is meant to be used client-side the browser field should be used instead of the main field. This is helpful to hint users that it might rely on primitives that arenâ€™t available in Node.js modules. (e.g. window)
     */
    ...
    /**
     * If someone is planning on downloading and using your module in their program, then they probably donâ€™t want or need to download and build the external test or documentation framework that you use.
     * In this case, itâ€™s best to map these additional items in a `devDependencies` object.
     */
...
/**
 * A â€œpersonâ€ is an object with a â€œnameâ€ field and optionally â€œurlâ€ and â€œemailâ€. Or you can shorten that all into a single string, and npm will parse it for you.
 */
