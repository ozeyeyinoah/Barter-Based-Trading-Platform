...
==================
  ...
  * Cleaning up the js styleâ€¦
  * expect tests now include message pass-through
  * packaging up browser-side changesâ€¦
...
==================
  ...
  * Fix typo: devDependancies â†’ devDependencies
...
==================
  ...
  * browser version built with pre/suffix â€¦ all tests passing
  ...
  * contain is now `include` â€¦ keys modifier is now `contain`
  * removed object() test
  * removed #respondTo
  * Merge branch 'bug/2'
