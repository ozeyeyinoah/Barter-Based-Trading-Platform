...
If N is the sum of lengths of sequences and L is length of a longest common subsequence, then D = N â€“ 2L is the number of **differences** in the corresponding shortest edit script.
...
The â€œedit graphâ€ analogy in the Myers paper shows the following common items:
...
const formatDiffLines = (a, b) => {
  ...
  const foundSubsequence = (nCommon, aCommon, bCommon) => {
    for (; aIndex !== aCommon; aIndex += 1) {
      array.push(`-Â·${aLinesIn[aIndex]}`); // delete is minus
    }
    for (; bIndex !== bCommon; bIndex += 1) {
      array.push(`+Â·${bLinesIn[bIndex]}`); // insert is plus
    }
    for (; nCommon !== 0; nCommon -= 1, aIndex += 1, bIndex += 1) {
      // For common lines, received indentation seems more intuitive.
      array.push(`Â·Â·${bLinesIn[bIndex]}`); // common is space
    }
  };
  ...
  for (; aIndex !== aLength; aIndex += 1) {
    array.push(`-Â·${aLinesIn[aIndex]}`);
  }
  for (; bIndex !== bLength; bIndex += 1) {
    array.push(`+Â·${bLinesIn[bIndex]}`);
  }
...
If N is the sum of lengths of sequences and L is length of a longest common subsequence, then N â€“ L is length of an array of diff lines. In this example, N is 7 + 9, L is 5, and N â€“ L is 11.

|  `i` | `diffLines[i]`                     | `aIndex` | `bIndex` |
| ---: | :--------------------------------- | -------: | -------: |
|  `0` | `'Â·Â·Object {'`                     |      `0` |      `0` |
|  `1` | `'Â·Â·Â·Â·"searching": "",'`           |      `1` |      `1` |
|  `2` | `'-Â·Â·Â·"sorting": Object {'`        |      `2` |          |
|  `3` | `'-Â·Â·Â·Â·Â·"ascending": true,'`       |      `3` |          |
|  `4` | `'+Â·Â·Â·Â·Â·"sorting": Array ['`       |          |      `2` |
|  `5` | `'+Â·Â·Â·Â·Â·Â·Â·Object {'`               |          |      `3` |
|  `6` | `'+Â·Â·Â·Â·Â·Â·Â·Â·Â·"descending": false,'` |          |      `4` |
|  `7` | `'Â·Â·Â·Â·Â·Â·Â·Â·Â·Â·"fieldKey": "what",'`  |      `4` |      `5` |
|  `8` | `'Â·Â·Â·Â·Â·Â·Â·Â·},'`                     |      `5` |      `6` |
|  `9` | `'+Â·Â·Â·Â·Â·],'`                       |          |      `7` |
| `10` | `'Â·Â·}'`                            |      `6` |      `8` |
